var kg = (function() {
    ...
    KgPackage.prototype = {
         ...
         * @this {KgPackage}
         **/
        "action": function(actionId, gridId) {
            return new (this.getAction(actionId))(gridId);
        },
        ...
        /**
         * @desc Create a modal instance.
         * @return {Modal}
         * @this {KgPackage}
         **/
        "modal": function(definition) {
            return new (this.getComponent(definition.id))(definition);
        },
        ...
        var computedInteger = ko.computed(
            {
                ...
                "write": function(input) {
                    var current = target();
                    var inputInteger = isNaN(input) || (input === '')? current :
                            parseInt(input, 10);
